 ...
 *
 * One product, one button → the Whop checkout overlay ($37 book, 60-day
 ...
 * Whop). `subline` is the optional urgency line
...
export default function SalesCTA({
   ...
   *  real discount is set in Whop (list $97 → launch $37). */
  regular?: string;
