...
function DepositMedia() {
  ...
  return (
    <video
      ...
      muted
      playsInline
      poster="/deposit/poster-3d.webp"
      aria-label="A slowly rotating chunk of Idaho gold-country ground — pine landscape on top, a gold-bearing quartz vein in the granite below."
    >
      <source src="/deposit/deposit-turntable.webm" type="video/webm" />
    </video>
  );
}
