    ...
    <section className="relative py-16 md:py-24">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-10 lg:gap-16 items-center">
          <div className="hidden lg:flex items-center justify-center order-1"><Book3D /></div>
          <div className="order-2 text-center lg:text-left">
            <p className="text-[10px] font-semibold tracking-[0.2em] uppercase text-gold mb-6">UNDERSTAND IT BEFORE WALL STREET DOES</p>
            <h2 className="text-tp font-extrabold tracking-[-0.035em] leading-[1.3]" style={{ fontSize: "clamp(2rem, 4.4vw, 3.75rem)" }}>
              Missed Bitcoin?<br />
              Don&rsquo;t wait to read about digital gold mining<br />
              <span className="text-gold">in the Wall Street Journal.</span>
            </h2>
            <p className="mt-8 text-ts leading-[1.7] max-w-[52ch] mx-auto lg:mx-0" style={{ fontSize: "clamp(1rem, 1.3vw, 1.125rem)" }}>Read it here first.</p>
            <form onSubmit={handleSubmit} noValidate className="mt-12 flex w-full max-w-[560px] mx-auto lg:mx-0 flex-col gap-3 sm:flex-row sm:items-stretch">
