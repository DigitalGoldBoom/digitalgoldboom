  ...
  return (
    <section className="relative py-14 md:py-[88px]">
      <div className="max-w-[1100px] mx-auto px-6 md:px-12">
        <p className="text-[10px] font-semibold tracking-[0.2em] uppercase text-gold mb-6 text-center">THE HALLEY&rsquo;S COMET ALIGNMENT</p>
        <h2 className="text-tp font-extrabold tracking-[-0.03em] leading-[1.3] text-center mx-auto" style={{ fontSize: "clamp(2rem, 4.2vw, 3.25rem)" }}>
          Three forces.<br />
          <span className="text-gold">Same window.</span>
        </h2>
        <p className="mt-8 text-ts leading-[1.7] text-center max-w-[56ch] mx-auto">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-stretch">
          {FORCES.map((f) => (
            <div key={f.n} className="border-t border-border pt-8 flex flex-col h-full">
        ...
        <p className="mt-16 text-center text-tp font-semibold max-w-[58ch] mx-auto leading-[1.55]" style={{ fontSize: "clamp(1.05rem, 1.4vw, 1.2rem)" }}>
