  ...
  return (
    <section className="relative py-14 md:py-20">
      <div className="max-w-[1100px] mx-auto px-6 md:px-12">
        <p className="text-[10px] font-semibold tracking-[0.2em] uppercase text-gold mb-6 text-center">WHO&rsquo;S BEHIND IT</p>
        <h2 className="text-tp font-extrabold tracking-[-0.03em] leading-[1.3] text-center max-w-[22ch] mx-auto" style={{ fontSize: "clamp(1.8rem, 3.6vw, 2.75rem)" }}>
          Built by people who built<br />
          <span className="text-gold">the old system.</span>
        </h2>
        <p className="mt-8 text-ts leading-[1.7] text-center max-w-[58ch] mx-auto" style={{ fontSize: "clamp(1rem, 1.3vw, 1.125rem)" }}>
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-stretch">
          {PEOPLE.map((p) => (
            <div key={p.org} className="border-t border-border pt-8 flex flex-col h-full text-center">
